...
skills:
  ...
  - requirement-tracing
  - tracker-sync
{%- if integrations.issue_tracker == "jira" %}
  - issue-tracking-jira
{%- elif integrations.issue_tracker == "linear" %}
  - issue-tracking-linear
{%- elif integrations.issue_tracker == "github" %}
  - issue-tracking-github
{%- elif integrations.issue_tracker == "azure-devops" %}
  - issue-tracking-azure
{%- endif %}
{%- if integrations.doc_tracker == "confluence" %}
  - doc-tracker-confluence
{%- elif integrations.doc_tracker == "notion" %}
  - doc-tracker-notion
{%- endif %}
---
