...
{%- if integrations.issue_tracker == "jira" %} mcp__atlassian__*
{%- elif integrations.issue_tracker == "linear" %} mcp__linear__*
{%- elif integrations.issue_tracker == "github" %} mcp__github__*
{%- elif integrations.issue_tracker == "azure-devops" %} mcp__ado__*
{%- endif %}
{%- if integrations.doc_tracker == "confluence" %} mcp__atlassian__*
{%- elif integrations.doc_tracker == "notion" %} mcp__notion__*
{%- endif %}
